...
<html lang="en">
	<head>
		...
		<meta name="description" content="Even great leaders leave money on the table and relationships unfulfilled.  We close the gap and vault you beyond great leadership.">
		<meta name="author" content="http://luke-danielson.com">
		<title>Clearlight Evolution - Evolve to Excel.  Excel to Fulfill</title>
		...
		<link href="css/app.1.1.css" rel="stylesheet">
	...
	<body>
		...
		<section id="about" class="section">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="section-title">About Clearlight Evolution</h2>
				...
				<div class="row">
					...
					<div class="about-copy">
						<p class="lead">Even great leaders leave money on the table and relationships unfulfilled.</p>
						<p class="lead">We close the gap and vault you beyond great leadership.</p>
					</div>
						<?php
						/*
						<div class="row">
				...
				<div id="teamCarousel" class="owl-carousel text-center">
					...
					<div class="text-center team-member-container wow fadeInDown" data-wow-delay="0.6s">
						<div class="team-member">
							...
							<div class="team-member-meta">
								<h4>Sophie Brown</h4>
								<span class="team-member-profession">Product manager</span>
								<p>Phasellus malesuada augue erat, quis mollis magna fermentum at. Donec lobortis ante et dictum.</p>
								<div class="social">
									<a href="#" class="btn btn-theme"><i class="fa fa-facebook"></i></a>
									<a href="#" class="btn btn-theme"><i class="fa fa-twitter"></i></a>
									<a href="#‎" class="btn btn-theme"><i class="fa fa-google-plus"></i></a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12 col-md-6 col-md-offset-3">
						<ul class="list-contacts centered">
							<li><h3 class="mb0">Peter Bromley</h3><p class="mb0">Chief Evolutionary Officer</p></li>
				...
				<div class="row">
					<div class="col-sm-12">
						<h3 class="ta-center uc"><a class="primary" href="https://clearlightevolution.wordpress.com" title="Visit Our Blog">Visit Our Blog</a></h4>
						<br>
						<h3 class="ta-center uc">Call Now or Come Back Soon.</h4>
					</div>
				</div>
