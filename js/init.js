...
$(function () {
	 ...
	 */
	 ...
	 if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Windows Phone|Opera Mini/i.test(navigator.userAgent) ) {
		$.backstretch([
			"video/eclipse-earth-001/ecle1.jpg"
		]);
	}
	else {
		$("body").vide({
		    mp4: 'video/eclipse-earth-001/ecle2.mp4',
		    webm: 'video/eclipse-earth-001/ecle1.webm',
		    ogv: 'video/eclipse-earth-001/ecle1.ogv',
		    poster: 'video/eclipse-earth-001/ecle1.jpg'
		}, { posterType: 'jpg' }); 
